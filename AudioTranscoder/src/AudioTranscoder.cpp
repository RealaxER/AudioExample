...
void log_info(AVFormatContext * format){
  std::cout << "Audio Name: " << format->iformat->name << std::endl;
  std::cout << "Audio Format: " << format->iformat->long_name << std::endl;
  std::cout << "Audio Duration: " << format->duration / AV_TIME_BASE << " seconds" << std::endl;
}
...
std::vector<std::vector<double>> AudioTranscoder::read(
